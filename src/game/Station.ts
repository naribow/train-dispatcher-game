...
export class Station {
  ...
  constructor(
    layoutType: 'simple' | 'complex' = 'simple',
    platformX: number = 50,
    platformY: number = 335,
    platformWidth: number = 1180,
    platformHeight: number = 50,
  ) {
  ...
  private createSimpleLayout(
    ...
    const railBottom = new Rail(
      { x: 0, y: railYBottom },
      { x: 1280, y: railYBottom },
      5,
      0xff00ff,
    ); // 画面の端から端まで、マゼンタ色
